...
<div class="container body" id="lemenu">
    ...
    <div class="main_container" >
      ...
      <div class="col-md-3 left_col" >
              ...
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-user"></i>SIM Module<span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    ...
                    <?php }?>
                    <?php if(isset($link_2) && in_array('subscriber', $link_2)){ ?>
                    <li><a href="<?php echo base_url()?>index.php/subscriber/history">Journal des installations</a>
                    </li>
                    <?php }?>
                ...
                <li>
                    ...
                    <a><i class="fa fa-paw"></i>TATOO<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu" style="display: none">
                        <?php if(isset($link) && in_array('pppoe', $link)){ ?>
                        <li><a href="<?php echo base_url();?>index.php/Bras">Bras</a></li>
                        <?php }?>
                        
                        <?php if(isset($link) && in_array('node', $link)){ ?>
                        <li><a href="<?php echo base_url();?>index.php/Node">Nodes</a></li>
                        <?php }?>
                        <?php if(isset($link) && in_array('hbs', $link)){ ?>
                        <li><a href="<?php echo base_url();?>index.php/Bsu">HBS</a></li>
                        <?php }?>
                        <?php if(isset($link) && in_array('hsu', $link)){ ?>
                        <li><a href="<?php echo base_url();?>index.php/Asu">HSU</a></li>
                        <?php }?>
                        <?php if(isset($link) && in_array('unknown', $link)){ ?>
                        <li><a href="<?php echo base_url();?>index.php/Asu/Unknown">Non enregistrés</a></li>
                        <?php }?>
		...
		<?php if(isset($link) && in_array('admin', $link)){ ?>
               <!--        -->
		 <li><a href="<?php echo base_url();?>index.php/licence"><i class="fa fa-desktop0 fa-lock"></i> Licence</a>
