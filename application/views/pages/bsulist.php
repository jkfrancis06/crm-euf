          ...
          <tbody>
		   ...
		   foreach($hosts as $host){
			...
			echo "</td>";
			 ...
			 echo "<a alt='Statut' title='Statut radio' href='".base_url()."index.php/wireless/bs_radio/".$host["id"]."' class='btn btn-warning ' data-name='".$host["name"]."' data-id='".$host["id"]."' ><i class='fa fa-plug' aria-hidden='true'></i></a>";
