...
<div class="modal fade" id="myDelete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
		...
		<div id="deletenodename"></div>
                Etes vous sur de vouloirsupprimer ce HSU?
            </div>
...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        ...
        <div class="x_content">
            <div class="row">
                <form class="form-horizontal" role="form" action="<?php echo base_url()."index.php/asu/getforbsu";?>" method="GET">	
                    <div class="col-md-6 col-md-offset-2">
                        <label class="col-md-4 control-label" for="node">HBS: </label>
                        <div class="col-md-8">
                            <select id="bsu" name="bsu" class="form-control" >
                                <?php if(!isset($bsuid) || empty($bsuid))  echo "<option value='' selected></option>";?>
                                <?php   foreach($bsulists as $bsu){
                                                  echo "<option value='".$bsu["id"]."' ";
                                                   if($bsuid==$bsu["id"]) echo "selected";
            ...
            <div class="row">
                <table 
                    data-toggle='table' data-show-columns='false' data-show-toggle='false' data-show-refresh='true'
                       data-local='fr_FR'  data-striped='true' data-pagination='true' data-page-size='10'
